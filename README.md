...
- **Full CI/CD pipeline** — 6 GitHub Actions workflows gate every PR (backend/frontend tests + lint, plus the full Cypress E2E suite run headless against the real Docker stack), plus a one-click manual Cloud Run preview deploy via GCP Workload Identity Federation.
...
| 007 | Warehouse Receiving & Location-Aware Stock | In Progress | 2026-08-30 | 23.1% (3/13) | 2026-09-22 | — | [sprint-007-warehouse-receiving-and-location-aware-stock.md](doc/sprints/sprint-007-warehouse-receiving-and-location-aware-stock.md) |
