...
- **Tracked:** `9.77h` (all 7 content sub-tasks complete — Policies, Dedicated exceptions, Extract duplicated literals, Reduce cognitive complexity, Simplify conditionals & control flow, Small/misc cleanups, TODO cleanup; only the final test-suite run and SonarCloud re-check remain)
