...
- **Tracked:** `5.88h` (in progress — Policies + Dedicated exceptions + Extract duplicated literals + Reduce cognitive complexity + Small/misc cleanups sub-tasks complete, 2 content sub-tasks remain: conditionals/control-flow, TODO cleanup)
