...
- **Tracked:** `8.75h` (in progress — Policies + Dedicated exceptions + Extract duplicated literals + Reduce cognitive complexity + Simplify conditionals & control flow + Small/misc cleanups sub-tasks complete, 1 content sub-task remains: TODO cleanup)
