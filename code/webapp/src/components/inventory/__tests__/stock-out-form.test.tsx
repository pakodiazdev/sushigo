...
function renderForm(props = formProps) {
    ...
    return render(
        React.createElement(
            QueryClientProvider,
            { client: queryClient },
            React.createElement(StockOutForm, props),
        ),
    )
}
...
describe('StockOutForm', () => {
    ...
    describe('rendering', () => {
        ...
        it('renders the header with title', () => {
            renderForm()
            expect(screen.getByRole('heading', { name: 'Register Stock Out' })).toBeDefined()
        })
        ...
        it('renders reason select with options', () => {
            renderForm()
            expect(screen.getByText('Sale (revenue generating)')).toBeDefined()
            expect(screen.getByText('Consumption (internal use)')).toBeDefined()
        })
        ...
        it('renders submit button', () => {
            renderForm()
            expect(screen.getByRole('button', { name: 'Register Stock Out' })).toBeDefined()
        })
    })
