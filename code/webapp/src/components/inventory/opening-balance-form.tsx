    ...
    <>
      ...
      <SlidePanel.Body>
        ...
        >
          ...
          {/* Structured movement reference */}
          <FormField
            label="Referencia"
            error={errors.reference}
            hint="Folio o identificador que podrás buscar en el historial (opcional)"
          >
            <Input
              {...register('reference')}
              maxLength={255}
              placeholder="p. ej., INV-INICIAL-2026-001"
              error={!!errors.reference}
            />
          </FormField>

          {/* Notes */}
          <FormField label="Notas" error={errors.notes} hint="Comentarios adicionales opcionales">
            <Textarea
              {...register('notes')}
              rows={3}
              placeholder="p. ej., Conteo inicial de inventario..."
            />
          </FormField>
        </form>
      </SlidePanel.Body>
