...
const mockEmployee: Employee = {
  ...
  employment_periods: [
    { id: '1', start_date: '2025-01-01', end_date: null, is_active: true },
  ],
  current_wage: { id: '1', daily_wage: 250, effective_from: '2025-01-01' },
...
describe('useEmployeeDetailActions', () => {
  ...
  it('detects hasActivePeriod from employment_periods if has_active_period is undefined', () => {
    const employeeWithPeriods: Employee = {
      ...
      employment_periods: [{ id: '1', start_date: '2025-01-01', end_date: null, is_active: true }],
    }
