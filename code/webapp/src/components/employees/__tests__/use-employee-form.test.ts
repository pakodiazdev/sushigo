...
const mockEmployee: Employee = {
  ...
  roles: [],
  branch_id: 1,
  branch: { id: 1, code: 'B1', name: 'Branch 1', region: null, timezone: 'America/Mexico_City', is_active: true, meta: null, created_at: '2026-01-01T00:00:00+00:00', updated_at: '2026-01-01T00:00:00+00:00' },
  operating_units: [],
