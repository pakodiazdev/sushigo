...
import { useBonusGroupsSection } from '@/pages/attendance/use-bonus-groups-section'
...
function BonusGroupsSection() {
    ...
    return (
        <div className="mt-10 max-w-xl">
            <h3 className="text-base font-semibold mb-1">Grupos de Bono</h3>
...
export function PunctualityConfigSection() {
    ...
    return (
        <div className="space-y-0">
            <div className="mb-6">
                <h3 className="text-base font-semibold mb-1">Rangos de Puntualidad</h3>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 max-w-xl">
                ...
                {ranges && (
                    <p className="text-xs text-muted-foreground px-1">
                        Rangos actuales: {ranges.map((r) => rangeLabel(r.min_seconds, r.max_seconds)).join(' · ')}
                    </p>
                )}
