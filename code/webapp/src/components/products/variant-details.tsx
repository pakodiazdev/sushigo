...
// Variant is done through Edit's Active checkbox, matching Product's own pattern.
export function VariantDetails({ variant, onEdit, onBack }: Readonly<VariantDetailsProps>) {
  return (
