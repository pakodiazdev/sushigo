...
use App\Http\Requests\EmployeeRequests\RejectEmployeeRequestRequest;
...
/**
 * @OA\Patch(
 *   path="/api/v1/employee-requests/{id}/reject",
 *   summary="Reject Employee Request",
 *   description="Rejects a pending employee request without creating a concrete entity.",
 ...
 *       required=false,
 *
 *       @OA\JsonContent(@OA\Property(property="reason", type="string", nullable=true, example="No procede"))
 *   ),
 *
 *   @OA\Response(
 *       response=200,
 ...
 * )
 */
class RejectEmployeeRequestController extends Controller
{
    public function __invoke(
        RejectEmployeeRequestRequest $request,
        string $id,
        ...
        $employeeRequest = $service->reject(
            $employeeRequest,
            $request->user(),
