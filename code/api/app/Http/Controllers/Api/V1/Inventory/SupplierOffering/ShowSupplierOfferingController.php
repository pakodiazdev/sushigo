 ...
 *   operationId="showSupplierOffering",
 *   summary="Get a Supplier Offering by ID",
 ...
 *
 *   @OA\Response(response=200, description="Supplier Offering retrieved successfully", @OA\JsonContent(allOf={@OA\Schema(ref="#/components/schemas/ResponseEntity"), @OA\Schema(@OA\Property(property="data", ref="#/components/schemas/SupplierOfferingResponse"))})),
 ...
 * )
 */
class ShowSupplierOfferingController extends Controller
{
    public function __invoke(Supplier $supplier, SupplierOffering $offering): SupplierOfferingResource
    {
