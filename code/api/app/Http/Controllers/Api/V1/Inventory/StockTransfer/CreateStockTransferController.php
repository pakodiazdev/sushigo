 ...
 *   @OA\Response(response=409, description="UOM conversion changed while creating the draft", @OA\JsonContent(ref="#/components/schemas/ResponseError")),
...
class CreateStockTransferController extends Controller
{
    ...
    public function __invoke(StoreStockTransferRequest $request): StockTransferResource|JsonResponse
    {
        try {
