 ...
 *     @OA\Property(property="start_date", type="string", format="date", example="2026-08-01", description="Derived MIN of dates — kept for range display/filtering"),
 *     @OA\Property(property="end_date", type="string", format="date", example="2026-08-05", description="Derived MAX of dates — kept for range display/filtering"),
 *     @OA\Property(property="dates", type="array", @OA\Items(type="string", format="date"), example={"2026-08-01", "2026-08-05"}, description="The exact individual days this vacation request covers"),
