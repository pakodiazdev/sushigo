...
/**
 * @OA\Schema(
 *   schema="UpdateOperatingUnitRequest",
 ...
 * )
 */
class UpdateOperatingUnitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'sometimes|required|string|in:BRANCH_MAIN,BRANCH_BUFFER,BRANCH_RETURN,EVENT_TEMP',
