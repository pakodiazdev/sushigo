...
class ReceiptReversalTest extends InventoryTestCase
{
    ...
    public function it_reconciles_a_fractional_unit_cost_exactly_on_full_reversal(): void
    {
        ...
        // Code review finding (#579 PR #626): total_value must accumulate the
        // receipt's own authoritative exact net_acquisition_amount (1,000),
        // not 240 * 4.1667 = 1,000.008 reconstructed from the rounded rate.
        $this->assertEquals(1000.0, (float) $stock->total_value);
