...
trait SeedsPassportClients
{
    /**
     * Create the Passport Personal Access and Password Grant oauth clients
     * if they don't already exist. Identical across Development and
     * Production — only the environment they run in differs.
     */
