...
class HolidayDefinitionSeeder extends RepeatableSeeder
{
    ...
    {
        return [
            self::floating('Jueves Santo', 'Jueves de Semana Santa; fecha flotante que varía cada año según el calendario litúrgico.', 'asueto', 1.0),
            self::floating('Viernes Santo', 'Viernes de Semana Santa; fecha flotante que varía cada año según el calendario litúrgico.', 'asueto', 1.0),
    ...
    private function optionalDefinitions(): array
    {
        return [
            ...
            self::floating('Sábado Santo', 'Sábado de Semana Santa; fecha flotante que varía cada año según el calendario litúrgico.', 'opcional', 1.0),
