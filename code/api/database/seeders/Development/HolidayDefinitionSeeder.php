...
class HolidayDefinitionSeeder extends RepeatableSeeder
{
    ...
    {
        return [
            self::floating('Jueves Santo', 'Jueves de Semana Santa; fecha flotante que varía cada año según el calendario litúrgico.', 'asueto', 2.0),
            self::floating('Viernes Santo', 'Viernes de Semana Santa; fecha flotante que varía cada año según el calendario litúrgico.', 'asueto', 2.0),
            self::fixed('Día de los Muertos', 'Tradición mexicana que honra a los difuntos, celebrada el 2 de noviembre.', 'asueto', 2.0, 11, 2),
            self::fixed('Día de la Virgen de Guadalupe', 'Festividad religiosa en honor a la Virgen de Guadalupe, patrona de México.', 'asueto', 2.0, 12, 12),
        ];
    }
    ...
    {
        return [
            self::fixed('Día de Reyes', 'Conmemora la llegada de los Reyes Magos; tradición cultural mexicana celebrada el 6 de enero.', 'opcional', 2.0, 1, 6),
            self::fixed('Día de las Madres', 'Festejo a las madres mexicanas; en México se celebra siempre el 10 de mayo.', 'opcional', 2.0, 5, 10),
            self::floating('Sábado Santo', 'Sábado de Semana Santa; fecha flotante que varía cada año según el calendario litúrgico.', 'opcional', 2.0),
            self::fixed('Día de Todos los Santos', 'Festividad religiosa que honra a todos los santos; antecede al Día de los Muertos.', 'opcional', 2.0, 11, 1),
            self::fixed('Nochebuena', 'Víspera de Navidad celebrada el 24 de diciembre; asueto cultural de amplia adopción.', 'opcional', 2.0, 12, 24),
            self::fixed('Víspera de Año Nuevo', 'Último día del año, celebrado el 31 de diciembre; asueto cultural de amplia adopción.', 'opcional', 2.0, 12, 31),
        ];
    }
