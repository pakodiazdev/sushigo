...
class CoreTestSeeder extends Seeder
{
    ...
    private const ROLES = [
        'super-admin', 'admin', 'inventory-manager',
        'manager', 'cook', 'kitchen-assistant', 'delivery-driver', 'acting-manager',
    ];
    ...
    private const PERMISSIONS = [
        ...
        'cash_registers.view', 'cash_registers.create', 'cash_registers.update', 'cash_registers.delete',
        'cash_terminals.view', 'cash_terminals.create', 'cash_terminals.update', 'cash_terminals.delete',
        'bank_accounts.view', 'bank_accounts.create', 'bank_accounts.update', 'bank_accounts.delete',
        'cash_sessions.view', 'cash_sessions.create', 'cash_sessions.update', 'cash_sessions.post',
        'cash_adjustments.view', 'cash_adjustments.create', 'cash_adjustments.update', 'cash_adjustments.delete', 'cash_adjustments.post',
        'cash_expenses.view', 'cash_expenses.create', 'cash_expenses.update', 'cash_expenses.delete', 'cash_expenses.post',
